...
export function SimulationLabPage() {
  ...
  async function remove() {
    if (!run || busy || !window.confirm(`Delete run ${run.run_id}? Before execution this cancels preparation or waiting, drains cleanup, then removes its in-memory evidence.`)) return;
